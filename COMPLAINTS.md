# Apple iCloud Passwords complaints, and how Open iCloud Passwords for Chrome compares

This maps 18 documented complaints about Apple's official iCloud Passwords
Chrome/Edge extension to what Open iCloud Passwords for Chrome does. "Verified" means an automated
...
| # | Complaint | Apple's behavior | Open iCloud Passwords for Chrome | Status |
|---|---|---|---|---|
