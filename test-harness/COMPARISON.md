...
- Extension B: Open iCloud Passwords for Chrome
...
1. Serve the folder (don't use `file://`, managers behave more like production over HTTP):
   ```bash
   cd "open-icloud-passwords/test-harness"
...
## 0. Pre-verified field detection (Open iCloud Passwords for Chrome)
...
| Check | Apple (A) | Open iCloud Passwords for Chrome (B) | Winner / notes |
|---|---|---|---|
...
| Field | Should offer? | Apple (A) | Open iCloud Passwords for Chrome (B) | Winner / notes |
|---|---|---|---|---|
...
| Case | Expected | Apple (A) | Open iCloud Passwords for Chrome (B) | Winner / notes |
|---|---|---|---|---|
...
| Scenario | Apple (A) | Open iCloud Passwords for Chrome (B) | Winner |
|---|---|---|---|
| 1.1 standard login |  |  |  |
| 1.2 two-step login |  |  |  |
...
- biggest win for Open iCloud Passwords for Chrome: ____________________________________________
